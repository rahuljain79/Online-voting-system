  ...
  <section class="sidebar" style="background-color: #BAB9B9">
    ...
    <div class="user-panel" style = "height: 60px">
      ...
      <div class="pull-left info "  >
        <p style="color: black ; font-size: 17px; font-family:Times"><?php echo $user['firstname'].' '.$user['lastname']; ?></p>
        <a><i class="fa fa-circle text-success "></i>  <b style=" color: red ; font-size: 15px; font-family:Times">Live </b></a>
      </div>
    </div>
    ...
    <ul class="sidebar-menu" data-widget="tree" style="background-color: #786974 ; color:white ; font-size: 15px; font-family:Times  " >
      <li class="header" style="background-color: #28272D ;color:white ; font-size: 18px; font-family:Times  ">REPORTS</li>
      <li class=""><a href="home.php"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
  <!-- <li class=""><a href="votes.php"><span class="glyphicon glyphicon-lock"></span> <span>Votes</span></a></li> -->
      <li class="header" style="background-color: #28272D ;color:white ; font-size: 18px; font-family:Times ">MANAGE</li>
      ...
      <li class="header" style="background-color:#28272D ;color:white ; font-size: 18px; font-family:Times">SETTINGS</li>
