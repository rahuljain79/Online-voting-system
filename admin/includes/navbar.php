<header class="main-header" style="background-color:#717A83 " >
  ...
  <nav class="navbar navbar-static-top " style="background-color: #717A83 ; margin-left:10px ;">
    ...
    <span class="logo-mini" style="background-color: #717A83 ;"><b>S</b>VS</span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg " style="background-color:#717A83 ;color:white ;margin-left: 20px; font-size: 22px; font-family:Times  "><marquee behavior="scroll" hspace= "0px"; direction="left"><b>Smart Voting System</b></marquee></span>
        ...
        <li class="dropdown user user-menu  " style="color:black">
          ...
          <ul class="dropdown-menu" style="background-color: #4d5863 ;color:black ; font-size: 17px; font-family:Times">
            ...
            <li class="user-footer" style="background-color: #90979e ;color:white ; font-size: 17px; font-family:Times" >
              <div class="pull-left " style="background-color: #90979e ;color:white ; font-size: 18px; font-family:Times">
                <a href="#profile" data-toggle="modal" class="btn btn-default btn-curve" style="background-color: #d2d5d8" id="admin_profile">Update</a>
              </div>
              <div class="pull-right" style="background-color:#90979e ;color:black ; font-size: 18px; font-family:Times">
