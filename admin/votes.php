...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="background-color:#E0FFFF ;color:black ; font-size: 17px; font-family:Times ">
    <!-- Content Header (Page header) -->
    <section class="content-header" style= "color:black ; font-size: 17px; font-family:Times">
      <h1><b>
        <center>Votes</center></b>
      </h1>
        ...
        <div class="col-xs-12">
          <div class="box"style="background-color: #d8d1bd">
            <div class="box-header with-border"style="background-color: #d8d1bd">
              <a href="#reset" data-toggle="modal" class="btn btn-danger btn-sm btn-curve"  style="background-color: #ff8e88;color:black ; font-size: 15px; font-family:Times"><i class="fa fa-refresh"></i> Reset</a>
            </div>
            <div class="box-body">
