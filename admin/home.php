...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="background-color: #E0FFFF " >
      ...
      <div class="col-lg-3 col-xs-6" style=" font-family:Times">
          ...
          <div class="small-box" style="background-color: Red">
            <div class="inner" style="background-color:#B0C4DE ;color:black ; font-size:15px;" >
              ...
              <p > <h4><b >No. of Positions </b> </p></h4>
            </div>
            <div class="icon">
              <i class="fa fa-cog"></i>
            </div>
            
            <a href="positions.php" class="small-box-footer " style="background-color:#4682B4 ; color:black ; font-size:18px"><b>More info </b><i class="fa fa-arrow-right"></i></a>
          </div>
        ...
        <div class="col-lg-3 col-xs-6" style=" font-family:Times">
          ...
          <div class="small-box bg-green">
            <div class="inner" style="background-color: 	#DEB887 ;color:black ; font-size:15px">
              ...
              <p> <h4><b >No. of Candidates </b></p></h4>
            </div>
            <div class="icon">
            ...
            <a href="candidates.php" class="small-box-footer" style="background-color:	#8B4513 ;color:black ; font-size: 18px"><b>More info </b><i class="fa fa-arrow-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6" style=" font-family:Times">
          ...
          <div class="inner" style="background-color: #B59B91 ;color:black ; font-size:15px; font-family:Times">
              ...
              <p> <b ><h4>Total Voters</h4> </b></p>
            </div>
            <div class="icon">
              <i class="fa fa-users"></i>
            </div>
            <a href="voters.php" class="small-box-footer "style="background-color:  #96837E ;color:black ; font-size: 18px"><b>More info </b><i class="fa fa-arrow-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6" style="color:black ; font-size: 15px; font-family:Times">
          ...
          <div class="inner" style="background-color: #778899 ;color:black ; font-size:15px; font-family:Times">
              ...
              <p> <b><h4>Voters Voted </h4></b></p>
            </div>
            <div class="icon">
              <i class="fa fa-edit"></i>
            </div>
            <a href="#" class="small-box-footer "style="background-color: #2F4F4F ;color:black ; font-size: 18px"><b>Total Votes</b></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
        ...
        <div class="col-xs-12" >
          <h3> <b>VOTES GRAPH
            <span class="pull-right">
              ...
              <!-- <a href="print.php" class="btn btn-success btn-sm btn-curve" style="background-color: #2E8B57 ;color:black ; font-size: 15px; font-family:Times "><span class="glyphicon glyphicon-print"></span> Print</a> -->
            </span>
         </b> </h3>
        </div>
      </div>
