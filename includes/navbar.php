  ...
  <nav class="navbar navbar-static-top" style="background-color:#717A83 ">
    <div class="container" style="background-color:#717A83 ">
      <div class="navbar-header" style="background-color:#717A83 ">
        <a href="#" class="navbar-brand" style="background-color:#717A83 ;color:black ; font-size: 22px; font-family:Times  "><b>SMART<b> VOTING</b> SYSTEM</a>
      ...
      <div class="navbar-custom-menu"  >
        <ul class="nav navbar-nav"  >
          ...
          <li><a href="logout.php"> <b style="color:black ; font-size: 22px;"> <i class=fa fa-sign-out"> </b></i> <b style="color:black ; font-size: 18px; font-family:Times  " >Logout</b></a></li>  
        </ul>
      </div>
      <!-- /.navbar-custom-menu -->
    </div>
